...
$link = $_POST['link'];
$query2 = mysqli_query($conn, "SELECT * FROM bookmark WHERE id = '$bookmarkId'");
...
?>
<div class="content">
    <form method='post' action='sendBookmark.php'>
        <div class='justify-content-center'>
            ...
            <ul class='list-group'>
                ...
                <li class='list-group-item'><label for='email'>Email: </label><input type='text' id='email'
                                                                                     ...
                                                                                     class='form-control'/></li>
                <li class='list-group-item'><label for='city'>Oras:</label><input type='text' id='city' name='city'
                                                                                  value='<?php echo $city ?>'
                                                                                  class='form-control'/></li>
